...
* xref:latest@components:[#if model.kind != "component" ][=model.kind]s[/#if]:[=model.name][#if model.kind != "other" ]-[=model.kind][/#if].adoc[[=model.title][#if model.kind != "other" ] [=humanReadableKind(model.kind)][/#if]][#if model.kind == "component" ], URI syntax: `[=model.syntax]`[/#if]
[/#list]
